...
const NavigationBar = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-gray-400 py-5 text-black">
        <span className="text-xl font-extrabold">Currently Offline</span>
        <span>
          (due to Railway hosting charges, I do not have money to host the
          backend for the whole month)
        </span>
      </div>
